...
public class MtmHead extends Model {
     ...
     * 見積有効期限
     */
    public String mitumoriYukoKigen;
    /**
     * 見積有効期限
     */
    public String sekoAtena;
    ...
    public static int GetMTInput() {
    	List<MtmHead> dataList = MtmHead.find.where().eq("mitumori_jotai", Stts.MT_INPUT).eq("sakujo_flg", DeleteFlag.NOMAL).orderBy("mitumori_no").findList();
    ...
    public static int GetMTInput(String pKaisyaCd, String pShitenCd) {
    	List<MtmHead> dataList = MtmHead.find.where().eq("mitumori_jotai", Stts.MT_INPUT).eq("mitumori_irai_kaisya", pKaisyaCd).eq("mitumori_irai_siten", pShitenCd).eq("sakujo_flg", DeleteFlag.NOMAL).orderBy("mitumori_no").findList();
    	return dataList.size();
    }
    /**
     * 見積回答済の件数を取得します
    ...
    public static int GetMTAnser() {
    	List<MtmHead> dataList = MtmHead.find.where().eq("mitumori_jotai", Stts.MT_ANSER).eq("sakujo_flg", DeleteFlag.NOMAL).orderBy("mitumori_no").findList();
    	return dataList.size();
    }
    /**
     * 見積回答済の件数を取得します
    ...
    public static int GetMTAnser(String pKaisyaCd, String pShitenCd) {
    	List<MtmHead> dataList = MtmHead.find.where().eq("mitumori_jotai", Stts.MT_ANSER).eq("mitumori_irai_kaisya", pKaisyaCd).eq("mitumori_irai_siten", pShitenCd).eq("sakujo_flg", DeleteFlag.NOMAL).orderBy("mitumori_no").findList();
    	return dataList.size();
    }
    /**
     * 発注の件数を取得します
    ...
    public static int GetMTOrder() {
    	List<MtmHead> dataList = MtmHead.find.where().eq("mitumori_jotai", Stts.MT_ORDER).eq("sakujo_flg", DeleteFlag.NOMAL).orderBy("mitumori_no").findList();
    	return dataList.size();
    }
    /**
     * 発注の件数を取得します
    ...
    public static int GetMTOrder(String pKaisyaCd, String pShitenCd) {
    	List<MtmHead> dataList = MtmHead.find.where().eq("mitumori_jotai", Stts.MT_ORDER).eq("mitumori_irai_kaisya", pKaisyaCd).eq("mitumori_irai_siten", pShitenCd).eq("sakujo_flg", DeleteFlag.NOMAL).orderBy("mitumori_no").findList();
    	return dataList.size();
    }
    /**
     * 受注確定の件数を取得します
    ...
    public static int GetMTCommit() {
    	List<MtmHead> dataList = MtmHead.find.where().eq("mitumori_jotai", Stts.MT_COMMIT).eq("sakujo_flg", DeleteFlag.NOMAL).orderBy("mitumori_no").findList();
    	return dataList.size();
    }
    /**
     * 受注確定の件数を取得します
    ...
    public static int GetMTCommit(String pKaisyaCd, String pShitenCd) {
    	List<MtmHead> dataList = MtmHead.find.where().eq("mitumori_jotai", Stts.MT_COMMIT).eq("mitumori_irai_kaisya", pKaisyaCd).eq("mitumori_irai_siten", pShitenCd).eq("sakujo_flg", DeleteFlag.NOMAL).orderBy("mitumori_no").findList();
    	return dataList.size();
    }
    /**
     * 施工完了の件数を取得します
    ...
    public static int GetMTSekou() {
    	List<MtmHead> dataList = MtmHead.find.where().eq("mitumori_jotai", Stts.MT_SEKOU).eq("sakujo_flg", DeleteFlag.NOMAL).orderBy("mitumori_no").findList();
    	return dataList.size();
    }
    /**
     * 施工完了の件数を取得します
    ...
    public static int GetMTSekou(String pKaisyaCd, String pShitenCd) {
    	List<MtmHead> dataList = MtmHead.find.where().eq("mitumori_jotai", Stts.MT_SEKOU).eq("mitumori_irai_kaisya", pKaisyaCd).eq("mitumori_irai_siten", pShitenCd).eq("sakujo_flg", DeleteFlag.NOMAL).orderBy("mitumori_no").findList();
    	return dataList.size();
    }
    /**
    ...
    public static List<MtmHead> GetMTStts(String pStts,String pKaisyaCd, String pShitenCd) {
    	List<MtmHead> dataList = MtmHead.find.where().eq("mitumori_jotai", pStts).eq("mitumori_irai_kaisya", pKaisyaCd).eq("mitumori_irai_siten", pShitenCd).eq("sakujo_flg", DeleteFlag.NOMAL).orderBy("mitumori_no").findList();
    	return dataList;
    }
    /**
     * 決済アラートデータを取得します
    ...
    public static List<MtmHead> GetMitumoriRetrieval(MtmRetrievalMatch pMrm) {
      ...
      sb.append(" SELECT mtm_head.* ");
      sb.append(" FROM mtm_head ");
      //----- LE フロント営業部の場合、見積条件を特殊追加 -----
      if (MstUser.Kengen.FRONT.equals(pMrm.kengen)) {
    	  sb.append(" INNER JOIN (SELECT * FROM mst_shiten WHERE kennaigai_flg = '"+ MstShiten.Kennaigai.KENNAI  +"') ms ");
    	  sb.append("ON mtm_head.mitumori_irai_kaisya = ms.kaisya_cd AND mtm_head.mitumori_irai_siten = ms.shiten_cd ");
      }
