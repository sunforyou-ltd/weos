...
//    public long pYobi2KaiTanka;
    ...
    public class KaizoSiyo {
       ...
       * 防蝕
       */
      public static final String BOUSYOKU     = "防蝕改造";
      /**
       * 重防蝕
       */
      public static final String JUBOUSYOKU   = "重防蝕改造";
      /**
       * 耐塩害
       */
      public static final String TAIENGAI     = "耐塩害改造";
      /**
       * 耐重塩害
       */
      public static final String TAIJUENGAI   = "耐重塩害改造";
      /**
       * 重防錆
       */
      public static final String JUBOSABI     = "重防錆改造";
    }
    /**
     * 分納区分
     * @author kimura
    ...
    public static List<MtmTaisyoSeihin> GetMTTaisyouSeihin(String pMtmno,long pEdaban) {
    	List<MtmTaisyoSeihin> dataList = MtmTaisyoSeihin.find.where().eq("mitumori_no", pMtmno).eq("edaban", pEdaban).orderBy("gyo_no").findList();
    	return dataList;
    }
